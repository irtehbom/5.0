...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","opium_marker","firearms_marker"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["cocaine_1"]): {_gather = "cocaine"; _val = 1;};
	case (_zone in ["opium_marker"]): {_gather = "uopium"; _val = 1;};
	case (_zone in ["firearms_marker"]): {_gather = "ufirearms"; _val = 1;};
