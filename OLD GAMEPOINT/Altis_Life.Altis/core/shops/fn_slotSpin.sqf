...
if(ftp_cash < _betamt) exitWith {hint format["You don't have enough money to play (%1$)",_betamt];};
ftp_cash = ftp_cash - _betamt;
...
switch (_slot) do
{
	case 111:{_winnings = 10000;}; 
	case 110:{_winnings = 2500;};
	case 123:{_winnings = 1800;};
	case 211:{_winnings = 1000;};
	case 123:{_winnings = 1600;};
	case 234:{_winnings = 1800;};
	case 345:{_winnings = 20000;};
	case 456:{_winnings = 2200;};
	case 567:{_winnings = 2400;};
	case 311:{_winnings = 2900;};
	case 411:{_winnings = 2900;};
	case 511:{_winnings = 2900;};
	case 611:{_winnings = 2900;};
	case 110:{_winnings = 2900;};
	case 112:{_winnings = 2900;};
	case 113:{_winnings = 2900;};
	case 114:{_winnings = 2900;};
	case 115:{_winnings = 2900;};
	case 116:{_winnings = 2900;};
	case 121:{_winnings = 2300;};
	case 131:{_winnings = 2300;};
	case 141:{_winnings = 2300;};
	case 151:{_winnings = 2300;};
	case 171:{_winnings = 2300;};
	case 121:{_winnings = 2300;};
	case 222:{_winnings = 11000;};
	case 333:{_winnings = 8000;};
	case 444:{_winnings = 8000;};
	case 555:{_winnings = 6000;};
	case 666:{_winnings = 80000;};
	case 777:{_winnings = 200000;};
	default {_winnings = 0;}
};
