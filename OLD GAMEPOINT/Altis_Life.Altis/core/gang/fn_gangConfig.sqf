...
life_fnc_gangGetUpgradePrice = {
	_currentRank = [_this, 0, 0, [0]] call BIS_fnc_param;
...
life_fnc_gangIsAllowed = {
	...
	_permission = [_this, 0, 0, [-1]] call BIS_fnc_param;
