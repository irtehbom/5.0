...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "bounty": {_var = "license_civ_bountyhunter"};
			case "hitman": {_var = "license_civ_hitman"};
			case "silver": {_var = "license_civ_silver"};
			case "clay": {_var = "license_civ_clay"};
			case "cobalt": {_var = "license_civ_cobalt"};
			case "lead": {_var = "license_civ_lead"};
			case "titanium": {_var = "license_civ_titanium"};
			case "firearms": {_var = "license_civ_firearms"};
			case "opium": {_var = "license_civ_opium"};
			case "hair": {_var = "license_east_air"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_bountyhunter": {_var = "bounty"};
			case "license_civ_hitman": {_var = "hitman"};
            case "license_civ_silver": {_var = "silver"};
			case "license_civ_clay": {_var = "clay"};
			case "license_civ_cobalt": {_var = "cobalt"};
			case "license_civ_lead": {_var = "lead"};
			case "license_civ_titanium": {_var = "titanium"};		
			case "license_civ_firearms": {_var = "firearms"};
			case "license_civ_opium": {_var = "opium"};	
			case "license_east_air": {_var = "hair"};			
