...
if((_curTarget getVariable["Escorting",false])) then {
	...
	switch (playerSide) do
	{
		case east:
		{
			_Btn2 buttonSetAction "[life_pInact_curTarget] call life_fnc_stopEscorting; [life_pInact_curTarget] call life_fnc_bountyInteractionMenu;";
		};
		case west:
		{
...
if (player distance (getMarkerPos "Kavala_Police_Station") <= 40 || player distance (getMarkerPos "Bounty_Hunter_Office_1") <= 40) then {
