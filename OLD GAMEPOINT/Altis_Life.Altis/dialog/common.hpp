...
class Life_RscControlsGroupNoHScrollbars: Life_RscControlsGroup
{
	class HScrollbar: HScrollbar
	{
		height = 0;
...
class Life_RscButtonMenu : Life_RscShortcutButton {
	...
	onMouseButtonUp = "[] call life_fnc_exploitCheck;";
...
class Life_RscButtonMenuOK : Life_RscButtonMenu
{
	idc = 1;
...
class Life_RscXPProgress 
{
	...
	colorBar[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", "0.4"};
};
...
class Life_RscTiles: Life_RscControlsGroupNoScrollbars
{
	idc = 115099;
	x = "safezoneX";
	y = "safezoneY";
