...
if((_building getVariable[format["bis_disabled_Door_%1",_door],0]) == 1) exitWith {hint "The door is already locked"};
...
switch (typeOf _building) do {
	...
	case "Land_Research_HQ_F": {_cpRate = 0.008;};
...
[[16, player, (call life_donator)], "life_fnc_xpGenericXPGain", false, false] spawn life_fnc_MP;
