...
if(isNil {grpPlayer getVariable "gangName"}) exitWith {titleText[localize "STR_GNOTF_CreateGang","PLAIN"];};
...
[[7, player, (call life_donator)], "life_fnc_xpGenericXPGain", false, false] spawn life_fnc_MP;
...
[[[0,1],"STR_GNOTF_CaptureSuccess",true,[name player,(group player) getVariable "gangName"]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
