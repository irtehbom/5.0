...
_affAirSpawn = nearestObjects[_sp,["Land_PressureWasher_01_F"],30];
if (count _affAirSpawn > 0) then {
_sp set [2,11.5];
};
...
_vehicle setVariable["vehicle_color",_vInfo select 8];
_vehicle setVariable["disable_police_impound",_vInfo select 1,true];
