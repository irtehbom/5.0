...
[_rate, _upp] call life_fnc_actionProgress;
...
if (playerSide == east) then {
	if (_vehicle getVariable["HATORequested", false]) then {
		hint "You've successfully refueled a vehicle for which a HATO mechanic was called. You've received a 20,000 dollar commission.";
