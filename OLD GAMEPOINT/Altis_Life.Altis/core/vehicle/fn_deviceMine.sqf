...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","silver_marker","clay_marker","cobalt_marker","lead_marker","titanium_marker","firearms_marker","opium_marker"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["silver_marker"]): {"usilver"};
	case (_zone in ["clay_marker"]): {"uclay"};
	case (_zone in ["cobalt_marker"]): {"ucobalt"};
	case (_zone in ["lead_marker"]): {"ulead"};
	case (_zone in ["titanium_marker"]): {"utitanium"};
	case (_zone in ["firearms_marker"]): {"ufirearms"};
	case (_zone in ["opium_marker"]): {"uopium"};
	default {""};
};
