...
if ((_x select 1) > 1 ) then {
	_name = [([(_x select 0),0] call life_fnc_varHandle)] call life_fnc_vartostr;
		...
		_itemHandle = _x select 0;
		if (_percentageDecrease > 0 && !(_itemHandle in ["heroinu", "heroinp", "cannabis", "marijuana", "cocaine", "cocainep", "salt", "salt_r", "goldbar", "treasure", "bonds", "iron_r", "copper_r", "diamond", "diamondc", "glass", "cement", "apple", "peach", "turtle","usilver", "uclay", "ucobalt", "ulead", "utitanium", "silver", "clay", "cobalt", "lead", "titanium","ufirearms", "firearms", "uopium", "opium"])) then {
