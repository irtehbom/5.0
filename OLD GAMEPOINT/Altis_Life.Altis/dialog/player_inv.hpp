...
class playerSettings {
	...
	class controls {
		...
		*/
		...
		class XPSystem : Life_RscButtonMenu {
			idc = -1;
			text = "XP/levels";
			onButtonClick = "[] call life_fnc_xpOpenMenu;";
			x = 0.42 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.805;
			w = (6.25 / 40);
			h = (1 / 25);
		...
		class joinPaintball : Life_RscButtonMenu {
			idc = -1;
			text = "Que for Paintball";
			onButtonClick = "[] call life_fnc_paintballJoin;";
			x = 0.256 + (1 / 250 / (safezoneW / safezoneH));
			y = 0.805;
			w = (10 / 40);
			h = (1 / 25);
		};
		...
		class CivBountyHunter : Life_RscButtonMenu {
			idc = 4012;
			text = "Bounty List";
			onButtonClick = "[] call life_fnc_wantedMenu";
			x = 0.1 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
