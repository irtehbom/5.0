...
_return = "";
if (["life_inv_build", _var] call BIS_fnc_inString) then {
	_result = [_var] call build_getObject;
	
	if (count _result > 0) exitWith { _return = _result select 0 };
};
...
switch (_var) do
{
	...
	case "life_inv_gpzipties": {(localize "STR_zipties")};
	...
	case "life_inv_bonds": {(localize "STR_Item_Bonds")};
	case "life_inv_blastingcharge": {(localize "STR_Item_BCharge")};
	case "life_inv_c4": {(localize "STR_Item_c4")};
	case "life_inv_boltcutter": {(localize "STR_Item_BCutter")};
	case "life_inv_defusekit": {(localize "STR_Item_DefuseKit")};
	case "life_inv_storagesmall": {(localize "STR_Item_StorageBS")};
	case "life_inv_storagebig": {(localize "STR_Item_StorageBL")};
	case "life_inv_sroll": {"Sausage Roll"};
	case "life_inv_crowbar": { "Crowbar" };
	case "life_inv_uwsl": {"Underwaterexplosive"};
	case "life_inv_usilver": { "Unprocessed Silver" };
	case "life_inv_uclay": {"Unprocessed Clay"};
	case "life_inv_ucobalt": { "Unprocessed Cobalt" };
	case "life_inv_ulead": {"Unprocessed Lead"};
	case "life_inv_utitanium": {"Unprocessed Titanium"};
	case "life_inv_silver": { "Processed Silver" };
	case "life_inv_clay": {"Processed Clay"};
	case "life_inv_cobalt": { "Processed Cobalt" };
	case "life_inv_lead": {"Processed Lead"};
	case "life_inv_titanium": {"Processed Titanium"};
	case "life_inv_firearms": {"Fixed Firearm Parts"};
	case "life_inv_ufirearms": {"Broken Firearm Parts"};
	case "life_inv_opium": {"Morphine"};
	case "life_inv_uopium": {"Unprocessed Opium"};
	...
	case "license_civ_bountyhunter": {"Bounty Hunter's Licence"}; 
	case "license_civ_hitman": {(localize "STR_License_Hitman")};
	case "license_civ_silver": {"Silver Processing Licence"}; 
	case "license_civ_clay": {"Clay Processing Licence"}; 
	case "license_civ_cobalt": {"Cobalt Processing Licence"}; 
	case "license_civ_lead": {"Lead Processing Licence"}; 
	case "license_civ_titanium": {"Titanium Processing Licence"}; 
	case "license_civ_firearms": {"Firearms Processing Licence"}; 
	case "license_civ_opium": {"Opium Processing Licence"}; 
	case "license_east_air": {"Hato Air License"}; 
};
