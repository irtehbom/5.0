...
/*
	File: fn_AAN_OilRig.sqf

*/
private ["_header","_line","_sender","_display","_textHeader","_textLine","_textLinePos","_textClock"];
_header = "The Oil Rig";
_line = "The Oil Rig is being robbed by some rebel(s). The police have urged calmness as they respond to the matter, any civilians are to evacuate the area as police will kill on sight";
