...
_return = [];
_stopYinventoryPaintball = _this select 0;
...
};
{
	...
	["life_inv_gpzipties", life_inv_gpzipties],
	...
	["life_inv_build_Pole_F", life_inv_build_Pole_F],
	["life_inv_build_O_supplyCrate_F", life_inv_build_O_supplyCrate_F],
	...
	["life_inv_usilver",life_inv_usilver],
	["life_inv_uclay",life_inv_uclay],
	["life_inv_ucobalt", life_inv_ucobalt],
	["life_inv_ulead",life_inv_ulead],
	["life_inv_utitanium",life_inv_utitanium],
	["life_inv_silver",life_inv_silver],
	["life_inv_clay",life_inv_clay],
	["life_inv_cobalt",life_inv_cobalt],
	["life_inv_lead",life_inv_lead],
	["life_inv_titanium",life_inv_titanium],
	["life_inv_sroll",life_inv_sroll]
];
...
if (!(_stopYinventoryPaintball)) then {
