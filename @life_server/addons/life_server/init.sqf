...
//diag_log format["DB_fnc_asyncCall DB_fnc_asyncCall DB_fnc_asyncCall DB_fnc_asyncCall DB_fnc_asyncCall DB_fnc_asyncCall %1",DB_fnc_asyncCall];
...
_oilRigBuilding allowDamage false;
