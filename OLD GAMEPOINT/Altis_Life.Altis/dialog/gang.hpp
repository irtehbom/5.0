class Life_My_Gang_Diag {
	...
	class controls {
		...
		class BuildingAreas : GangLeader
		{
			idc = 2635;
			text = "Toggle building zones";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] spawn life_fnc_buildShowMarkers; closeDialog 0;";
			w = 0.3;
			y = .64;
			x = 0.11;
		};
		
		class RemovePlotpole : GangLeader
		{
			idc = 2640;
			text = "Remove plot pole";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] spawn life_fnc_buildRemovePlot";
			w = 0.3;
			y = .69;
			x = 0.11;
		};
