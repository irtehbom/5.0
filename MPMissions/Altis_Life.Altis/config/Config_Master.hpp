...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit","Amethyst","Ametrine","Aquamarine","Bloodstone","Blue_Saphire","Citrine","Emerald","Opal","Quartz","Ruby","zipties","blindfold" }; //Array of virtual items that can be saved on your player.
...
/* System Settings */
	...
	minimum_cops_drugs_stash = 3; // Drugs stash
    /*Death settings*/
    ...
    news_broadcast_cost = 10000; //Cost for a player to send a news station broadcast.
    ...
    jail_seize_vItems[] = { "spikeStrip","lockpick","goldbar","blastingcharge","boltcutter","defusekit","heroin_unprocessed","heroin_processed","cannabis","marijuana","cocaine_unprocessed","cocaine_processed","turtle_raw","steel_bolt_cutter" }; //Define VIRTUAL items you want to be removed from players upon jailing here. Use "jail_seize_inventory" for Arma inventory items.
    ...
    sendtoJail_locations[] = { "cop_spawn_1", "pyrgosjail", "cop_spawn_3", "cop_spawn_5", "Correctional_Facility","police_hq_3" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    jail_forceWalk = true;
    ...
    seize_uniform[] = { "U_Rangemaster","U_B_CombatUniform_mcam" }; //Any specific uniforms you want to be seized from players
