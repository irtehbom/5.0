...
1 cutText["", "BLACK FADED"];
1 cutFadeOut 99999999;
[
	"<t size='0.8' color='#00FF00' align='center'>Welcome to Gamepoint</t><br /><t size='0.65' color='#FFFFFF' align='center'>The server is spawning your gang bases, please hang on</t>",
...
[] spawn life_fnc_consumeFuel;

if (life_firstSpawn) then {
	life_firstSpawn = false;	
};

[] call life_fnc_realEstateConfig;