...
_num = ctrlText 3505;
_safeInfo = life_herObj getVariable["heroind",0];
...
//if(_ctrl != "heroinp") exitWith {hint localize "STR_Cop_OnlyGold"};
...
life_herObj setVariable["heroind",_safeInfo - _num,TRUE];
