...
switch (life_veh_shop select 0) do
{
	...
	case "gang_vehicles": {_ret = true;};
	case "bounty_car": { _ret = true; };
	case "jetseller": { _ret = true; };
	case "aff_air_shop": { _ret = true; };
	case "aff_car_shop": { _ret = true; };
	case "donator_spawn_air": { _ret = true; };
	case "donator_spawn_shop": { _ret = true; };
	case "hato_air": {_ret = true; };
};
